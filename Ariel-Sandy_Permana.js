 ...
 const Options = require('./Ariel-SP_Fifah/settings/options.js')
 const { info } = Options
 const { color, bgcolor, ConsoleLog, getBuffer } = require('./Ariel-SP_Fifah/function.js')
 const { state, saveState } = useSingleFileAuthState('./Aespi-MD.json');    
 const { groupResponse } = require('./Ariel-SP_Fifah/response/group.js')
 const { move } = require('./Ariel-SP_Fifah/base/mybase')
 ...
 store.bind(sock.ev)  
  ...
  sock.ev.on('messages.upsert', async ({ messages }) => {
    ...
    require('./Ariel-SP_Fifah/message/Base-Ariel-Sandy-Permana.js')(sock, m, store)
