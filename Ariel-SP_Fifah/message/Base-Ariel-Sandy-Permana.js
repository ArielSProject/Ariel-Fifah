...
const ph = require('../scrape/photooxy.js')
 ...
 const geayubi = fs.readFileSync("./Ariel-SP_Fifah/scrape/Result/Asupan/geayubi.json");
 const bocil = fs.readFileSync("./Ariel-SP_Fifah/scrape/Result/Asupan/bocil.json");
 const rikagusriani = fs.readFileSync("./Ariel-SP_Fifah/scrape/Result/Asupan/rikagusriani.json");
 ...
 const tebakkimia = fs.readFileSync('./Ariel-SP_Fifah/scrape/Result/Game/tebakkimia.json');
 const asahotak = fs.readFileSync('./Ariel-SP_Fifah/scrape/Result/Game/asahotak.json');
 const susunkata = fs.readFileSync('./Ariel-SP_Fifah/scrape/Result/Game/susunkata.json');
 const tebakkalimat = fs.readFileSync('./Ariel-SP_Fifah/scrape/Result/Game/tebakkalimat.json');
 const tekateki = fs.readFileSync('./Ariel-SP_Fifah/scrape/Result/Game/tekateki.json');
 const caklontong = fs.readFileSync('./Ariel-SP_Fifah/scrape/Result/Game/caklontong.json');
 const tebakbendera = fs.readFileSync('./Ariel-SP_Fifah/scrape/Result/Game/tebakbendera.json');
 const tebakanime = fs.readFileSync('./Ariel-SP_Fifah/scrape/Result/Game/tebakanime.json');
 const tebakkabupaten = fs.readFileSync('./Ariel-SP_Fifah/scrape/Result/Game/tebakkabupaten.json');
 const tebaklagu = fs.readFileSync('./Ariel-SP_Fifah/scrape/Result/Game/tebaklagu.json');
 const tebaklirik = fs.readFileSync('./Ariel-SP_Fifah/scrape/Result/Game/tebaklirik.json');
...
const MenuList2 = `Hii *${m.pushName}* ${ucapanWaktu}`
...
const randomAriel = `✘ *R A N D O M - M E N U*\n\n⌕ ${prefix}patrik\n⌕ ${prefix}penyegar\n⌕ ${prefix}moodbooster\n⌕ ${prefix}waifu\n⌕ ${prefix}simi\n⌕ ${prefix}awoo\n⌕ ${prefix}shinobu\n⌕ ${prefix}couple\n⌕ ${prefix}aesthetic\n⌕ ${prefix}artinama\n⌕ ${prefix}storywa\n⌕ ${prefix}asupan\n⌕ ${prefix}ytsertificate\n⌕ ${prefix}igsertificate`
...
if (q.includes('--help')) return reply(examkosong) 
     reply(`*Tunggu Kak ><*`)
const Ariell = fs.readFileSync("./Ariel-SP_Fifah/scrape/Result/RandomImage/aesthetic.json");
...
if (q.includes('--help')) return reply(examkosong) 
     reply(`*Tunggu Kak ><*`)
const Ariel1 = fs.readFileSync("./Ariel-SP_Fifah/scrape/Result/RandomVideo/storywa.json");
...
if (q.includes('--help')) return reply(examquery) 
  ...
  break
case 'ytsertificate':
if (!q) return reply(`Penggunaan *${order}*\n\nContoh : ${prefix + order} ${m.pushName}`)
reply(`Tunggu Kak`)
sock.sendMessage(from, {caption: `*${q}*`, image: { url: `https://zenzapis.xyz/ephoto/ytcertificate?text=${q}&apikey=dc311285aa`}}, {quoted: m})
break
case 'igsertificate':
if (!q) return reply(`Penggunaan *${order}*\n\nContoh : ${prefix + order} ${m.pushName}`)
reply(`Tunggu Kak`)
sock.sendMessage(from, {caption: `*${q}*`, image: { url: `https://zenzapis.xyz/ephoto/igcertificate?text=${q}&apikey=dc311285aa`}}, {quoted: m})
break
  case 'arielpetir2':{
if (q.includes('--help')) return reply(examquery) 
    if (args.length < 1) return m.reply(from, `Contoh : ${prefix+order} ${Options.info.ownerName}`, { quoted : m } )
...
Silahkan Klick Button Dibawah Untuk Melihat Beberapa Fitur Yang Tersedia`
                let sections = [ { title: `${m.pushName} ${ucapanWaktu}`, rows: [ { title: "🐬 All Menu", rowId: "#menu2", description: `Menampilkan Semua Menu *${Options.info.botName}*`},{title: "🐬 Group Menu", rowId: ".groupmenu", description: "Menampilkan Menu Group"},{title: "🐬 Download Menu", rowId: "#downloadmenu", description: "Menampilkan Menu Download"},{title: "🐬 Random Video", rowId: "#videomenu", description: `Random Video By ${Options.info.ownerName}`},{title: "🐬 Convert Menu", rowId: "#convertmenu", description: "Menampilkan Menu Convert"},{title: "🐬 RPG Menu", rowId: "#rpgmenu", description: "Menampilkan Menu RPG ⚔️"},{title: "🐬 Textpro Menu", rowId: "#textpromenu", description: "Menampilkan Menu Textpro"},{title: "🐬 Info Menu", rowId: "#infomenu", description: "Menampilkan Menu Informasi"},{title: "🐬 Google Menu", rowId: "#googlemenu", description: "Menampilkan Menu Google"},{title: "🐬 Fun Menu", rowId: "#funmenu", description: "Menampilkan Menu Fun & Enjoy"},{title: "🐬 Random Menu", rowId: "#randommenu", description: "Menampilkan Menu Random"},{title: "🐬 Sound Menu", rowId: "#soundmenu", description: "Menampilkan Menu Musik"},{title: "🐬 Kisah Menu", rowId: "#kisahmenu", description: "Menampilkan Menu Kisah Nabi"},{title: "🐬 Anime Menu", rowId: "#animemenu", description: "Menu Untuk Para Wibu"},{title: "🐬 Tools Menu", rowId: "#toolsmenu", description: "Menampilkan Menu Tools"},{title: "🐬 MTK Menu", rowId: "#mtkmenu", description: "Menampilkan Menu MTK"},{title: "🐬 Game Menu", rowId: "#gamemenu", description: "Menampilkan Menu Game"},{title: "🐬 WA Imun Menu", rowId: "#wamenu", description: "WhatsApp Anti Virtex"}, ]}    ]
  ...
  case 'videomenu':{
 {
  ...
  case 'asumenu':{
 {
                let sections = [ { title: `${m.pushName} ${ucapanWaktu}`, rows: [ { title: "🎥 Asupan Geayoubi", rowId: "#asupan geayubi", description: "Random Video Geayoubi"},{title: "🎥 Asupan Bocil", rowId: "#asupan bocil", description: "Random Video Bocil Sexy"},{title: "🎥 Asupan Rikagusriani", rowId: "#asupan rikagusriani", description: "Random Video Rikagusriani"}, ]}    ]
...
let iphone = [{
      ...
      quickReplyButton: {
       ...
       id: '#waariel https://www.mediafire.com/file/mz37h4v0hmaj0ox/Aespi-Botz.apk/file'
       }
       }, 
       {
     index: 2, 
...
case 'rpgmenu':{
    {
                let sections = [ { title: `${m.pushName} ${ucapanWaktu}`, rows: [ { title: "[ 🏹 ] Berburu", rowId: "#berburu", description: "Berburu Di Hutan"},{title: "[ 🎣 ] Memancing Ikan", rowId: "#mancing", description: "Memancing Ikan"},{title: "[ ⛏️ ] Menambang", rowId: "#menambang", description: "Menambang Untuk Mendapatkan Emas"},{title: "[ ⚒️ ] Mining", rowId: "#mining", description: "Mining Yuk"},{title: "[ ♥️ ] Mengisi Darah", rowId: "#heal", description: "Mengisi Darah Agar Kamu Tidak Mati"}, ]}    ]
...
case 'inikuis':{
	{
                let sections = [ { title: `${m.pushName} ${ucapanWaktu}`, rows: [ { title: "Kuis Math Gampang", rowId: "#kuismath noob", description: "Ez"},{title: "Kuis Match Sedang", rowId: "#kuismath easy", description: "Ea"},{title: "Kuis Math Medium", rowId: "#kuismath medium", description: "Lumayan Broh"},{title: "Kuis Math Hard", rowId: "#kuismath hard", description: "Hm"},{title: "Kuis Math Extreme", rowId: "#kuismath extreme", description: "extreme"},{title: "Kuis Math Deathzone", rowId: "#kuismath deathzone", description: "Males Kasih Judul"}, ]}    ]
...
if (q.includes('--help')) return reply(examplyme) 
   ...
   if (m.isQuotedImage) {
    ...
    fs.writeFileSync(`./${ran}`, buffer)
     ...
     .on("end", () => {
      exec(`webpmux -set exif ./Ariel-SP_Fifah/sticker/data.exif ./${ran} -o ./${ran}`, async (error) => {
      sock.sendMessage(
          from, 
          { 
  ...
  if (m.isQuotedVideo) {
   ...
   var rand2 = '777.webp'
	fs.writeFileSync(`./${rand2}`, buffer)
	 ...
	 .on("error", console.error)
	 .on("end", () => {
	 exec(`webpmux -set exif ./Ariel-SP_Fifah/sticker/data.exif ./${rand2} -o ./${rand2}`, async (error) => {
	 sock.sendMessage(
	  from, 
	    { 
...
if (q.includes('--help')) return reply(examquery) 
 ...
 case 'youtube':{
  if (q.includes('--help')) return reply(examlink) 
  if (args.length < 1) return reply(`Contoh : ${prefix + order} link video youtube`)
  let yungtub = [{
  	index: 1, 
      quickReplyButton: {
       displayText: '🎧 Audio', 
